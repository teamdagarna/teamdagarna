...
export class ApplicationNewComponent implements AfterViewInit {
  ...
  ngAfterViewInit(): void {
    window.Jexpo = (window.Jexpo || []).concat(function(){
      Jexpo.widget('/team/bundles/participants-portal.jsx', '#participants-portal');
    });
  ...
  checkTime() {
    ...
    // Close at 31 August 2026, 23:59:59
    const closeApplicationDate = new Date(2026, 7, 31, 23, 59, 59);
